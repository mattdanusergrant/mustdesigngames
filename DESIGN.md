...
- **Sigils** (`card.hero === "sigil"`, 10 cards shared across every deck) have no owner. Any unit may cast any sigil. Casting a sigil consumes **both the move and the action** for the turn. Sigils are **removed from the game** on use.
